...
3. for the lightComponentSelectors method on line 43 of the basicSettings.ts file, removed the "[0]" from the rooms[0] since this.getComponent() is expected to return a string, having [0] would return the letter at the first index of the string instead of the entire string.
